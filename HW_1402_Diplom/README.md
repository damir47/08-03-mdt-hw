...
<span style="color:red">**Скорее всего сервера перед проверкой уже выключатся (грант закончится). Если потребуется включить - свяжитесь через чат/почту и т.п. и договоримся о времени включения**</span>
